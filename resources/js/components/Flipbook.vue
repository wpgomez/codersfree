<template>
  <div>
    <div
      ...
      @wheel="onWheel"
    >
      <div class="container-div" :style="{ transform: `scale(${zoom})`, }">
...
export default
  ...
  methods:
    ...
    flipAuto: (ease) ->
      ...
      @pageReturn.displayedPages = @displayedPages
      @$emit "flip-#{@flip.direction}-start", @pageReturn
      animate = => requestAnimationFrame =>
        ...
        if ratio < 1
          ...
          @pageReturn.page = @page
          @pageReturn.displayedPages = @displayedPages
          @$emit "flip-#{@flip.direction}-end", @pageReturn
